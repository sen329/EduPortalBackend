...
<table id="example1" class="table table-bordered table-striped">
                ...
                <th scope="row" >{{$timetable->id}}</th>
                  ...
                  <td>
                      <a href="{{route('timetable.edit', $timetable->id)}}"><button type="button" class="btn btn-xs btn-primary float-left">Edit Class</button></a>
                      <form class="delete" action='{{ route("timetable.destroy", $timetable)  }}' method="POST">
              ...
              <script type="text/javascript">
                ...
                {
                    var id = id;
                    var url = '{{ route("timetable.destroy", $timetable) }}';
