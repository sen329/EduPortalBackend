...
class LecturerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.lecturers.index')->with([
            'users'=>$users
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('staff.lecturers.create')->with([
            'subjects' =>$subjects,
            'lecturers' => $lecturers
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        // dd($request->all());
            try{
                ...
                return redirect()->route('staff.lecturer.index')->with("Sucesss");
            }
            catch(Exception $e){
                DB::rollback();
                // dd($e);
    ...
    public function edit(User $lecturer)
    {
        ...
        return view('staff.lecturers.edit')->with([
            'user'=>$lecturer,
            'subjects'=>$subjects,
        ]);
    }
    ...
    public function destroy(User $lecturer)
    {
        ...
        return redirect()->route('staff.lecturer.index');
    }
}
